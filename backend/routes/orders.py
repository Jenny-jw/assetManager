...
def create_order(
    ...
    return order_service.place_order(payload, current_user)
...
def list_orders(
    ...
    return order_service.list_orders_for_user(current_user, page=page, limit=limit)

@router.get("/{order_id}", response_model=OrderResponse)
def get_order(order_id: str, current_user: dict = Depends(get_current_user)):
    return order_service.get_order_for_user(order_id, current_user)
